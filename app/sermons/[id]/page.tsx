    ...
    <>
      ...
      <main>
        <div style={{ background: 'linear-gradient(160deg, var(--navy), var(--navy-mid))', padding: '140px 24px 60px', textAlign: 'center' }}>
          {sermon.series && <div style={{ fontFamily:'Montserrat,sans-serif', fontSize:10, letterSpacing:3, color:'var(--orange)', textTransform:'uppercase', marginBottom:16, background:'rgba(232,76,14,0.1)', display:'inline-block', padding:'4px 14px', borderRadius:2 }}>{sermon.series}</div>}
          ...
          <div style={{ display:'flex', justifyContent:'center', gap:24, flexWrap:'wrap' }}>
            <span style={{ fontFamily:'Montserrat,sans-serif', fontSize:12, color:'rgba(255,255,255,0.7)' }}> {sermon.speaker}</span>
            {sermon.scripture && <span style={{ fontFamily:'Montserrat,sans-serif', fontSize:12, color:'var(--orange)' }}> {sermon.scripture}</span>}
        ...
        <div style={{ background:'var(--off-white)', padding:'64px 24px 80px' }}>
          <div style={{ maxWidth:900, margin:'0 auto' }}>
            ...
            {sermon.audio_url && (
              <div style={{ marginBottom:48, background:'white', border:'1px solid rgba(232,76,14,0.2)', borderRadius:4, padding:24, boxShadow:'var(--shadow)' }}>
                <div style={{ fontFamily:'Montserrat,sans-serif', fontSize:11, letterSpacing:2, color:'var(--orange)', textTransform:'uppercase', marginBottom:12 }}>🎵 Listen to Audio</div>
            ...
            {/* Description */}
            {sermon.description && (
              <div style={{ fontFamily:'Cormorant Garamond,serif', fontSize:20, color:'var(--text-mid)', lineHeight:1.85, marginBottom:32, fontStyle:'italic', borderLeft:'3px solid var(--orange)', paddingLeft:24 }}>
                {sermon.description}
              </div>
            )}
            ...
            {sermon.content && (
              <div>
                <h2 style={{ fontFamily:'Playfair Display,serif', fontSize:28, color:'var(--navy)', marginBottom:24 }}>Sermon Notes</h2>
